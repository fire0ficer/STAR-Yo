...
<!---header-->
	 ...
	 <div class="container-fluid header">
		...
		<div class="span2">	<a href="index.php"> Home	</a></div>
		<div class="span2">	<a href="korzina.php"> Baskets</a>	</div>
		</div>
	</div>
<!----------->
...
<a href="changeproizvod.php?id_prov=<?php echo $row['id_prov'];?>">Изменить</a>
<a href="delproizvod.php?id_prov=<?php echo $row['id_prov'];?>">Удалить</a><br>
<?php
echo "<ul>";
...
<a href="addproizvod.php"> Cоздать</a>
</div>
<div class="span9">
<div>
<ul class="offset3 ">
...
<ul>
	...
	<li> <a href="changetovar.php?id_tov=<?php echo $row3['id_tov'];?>">Изменить</a></li>
	<li> <a href="deltovar.php?id_tov=<?php echo $row3['id_tov'];?>">Удалить</a></li>
	<li> <a href="addtovar.php"> Cоздать</a> </li>
</ul>
</li>
						<?php }?>
					</ul>
