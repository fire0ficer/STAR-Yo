...
<head>
<title>Заказы заверщенные</title>
...
<b><a href="comzak.php"><span>  Показать заказы, которые уже выполены</span></a></b>	<br><br> <? // началось   
	$query = 'SELECT * FROM `zakaz` where status=3 or status=5 ORDER BY idzak DESC';
	...
	<CAPTION ALIGN=TOP><h1 align=center></br>Выполненеые заказы:</h1></CAPTION>
