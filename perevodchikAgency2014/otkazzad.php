...
<head>
<title>Задания от которых отказались</title>
...
<b><a href="zadnaprov.php "><span>Задания, ждущие проверки </span></a><br><br>	</b>	 
 ...
 <? // началось   
	$query = 'SELECT * FROM `zadan`where status=4 or status=5 ORDER BY idzad DESC';
	...
	<CAPTION ALIGN=TOP><h1 align=center></br>Задания от которых отказались:</h1></CAPTION>
