...
<head>
<title>Новый профиль исполнителя</title>
...
<div id="header">
  ...
  <div class="center">
	 ...
	 if ($_GET['t']==1){
		...
		$query1 = "INSERT INTO `isp`(`idacc`, `fio`, `org`, `dopkont`, `dopdan`,`yaz`, `uslugi`) VALUES (\"$idacc\",\"$fio\",\"$org \",\"$dopkont\",\"$dopdan\",\"$yaz\",\"$uslugi\")";
...
if ($t!=2){ ?><br><br>
<form  enctype="multipart/form-data" action="newproi.php?t=1"  method="post">
	 ...
	 <P> Укажите языки : &nbsp; &nbsp; <INPUT NAME="yaz" value='<? echo $_POST['yaz']?>' SIZE="60">
	 <P> Укажите услуги : &nbsp; <INPUT NAME="uslugi" value='<? echo $_POST['uslugi'] ?>' SIZE="60">
