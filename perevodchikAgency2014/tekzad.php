...
<head>
<title>Задания выполняемые сейчас</title>
...
<b><a href="zadnaprov.php "><span>Задания, ждущие проверки </span></a><br><br>	</b>	 
 ...
 <? // началось   
	$query = 'SELECT * FROM `zadan`where status=0 or status=1 ORDER BY idzad DESC';
	...
	<CAPTION ALIGN=TOP><h1 align=center></br>Задания выполняемые сейчас:</h1></CAPTION>
