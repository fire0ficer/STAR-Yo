...
<div id="header">
  ...
  <div class="center">
	 ...
	 <? // началось   
	 $a=$_GET['id'];
	 $query = "DELETE FROM `acc` where accid=$a";
	$result = MYSQL_QUERY($query);
echo "Аккаунт № $a удален";	?>
	<center><input type="button" style="width:200px;height:24px;" value="Выход" onClick='location.href="acc.php"'></center>
