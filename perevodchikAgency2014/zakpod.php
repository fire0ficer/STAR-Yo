...
<head>
<title>Заказы на подтверждения </title>
...
<b><a href="comzak.php"><span>  Показать заказы, которые уже выполены</span></a></b>	<br><br> <? // началось   
	$query = 'SELECT * FROM `zakaz` where status=2 and prov is null ORDER BY idzak DESC';
	...
	<CAPTION ALIGN=TOP><h1 align=center></br>Заказы подтвержденные пользователем:</h1></CAPTION>
