...
<div id="header">
  ...
  <div class="center">
	 ...
	 if ($_GET['t']==1){
		...
		$query1 = "UPDATE `client` SET `idacc`='$idacc', `fio`='$fio', `org`='$org', `dopkont`='$dopkont', `dopdan`='$dopdan' WHERE id=$id";
...
<br><br>
<form  enctype="multipart/form-data" action="iprok.php?t=1&id=<? echo $id?>"  method="post">
