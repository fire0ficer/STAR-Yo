...
<head>
<title>Ждущие проверку задания</title>
...
<b><a href="zadnaprov.php "><span>Задания, ждущие проверки </span></a><br><br>	</b>	 
 ...
 <? // началось   
	$query = 'SELECT * FROM `zadan`where status=3 ORDER BY idzad DESC';
	...
	<CAPTION ALIGN=TOP><h1 align=center></br>Ждущие проверку задания:</h1></CAPTION>
